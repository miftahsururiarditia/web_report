...
<body class="fix-header fix-sidebar card-no-border">
    ...
    <div class="page-wrapper">
        <div class="container-fluid">
            <h3>Ina Principal Report</h3>
            <div class="row">
                <div class="col-12 col-lg-12">
                    <div class="card" style="padding: 10px;">
                        <div class="card-body">
                            <form method="GET" action="<?php echo base_url(); ?>index.php/ina_principal_report"> 
                            <div class="row">
                                <div class="col-lg-3">
                            ...
                            <div class="pull-right">
                                <a href="<?php echo base_url().'index.php/report/ina_principal_report_export/'.$tgl_awal.'/'.$tgl_akhir; ?>" class="btn btn-success" style="padding-right: 10px">
