            ...
            <div class="row">
                <div class="col-12 col-lg-12">
                    <div class="card">
                        ...
                        <div class="card-body">
                            <form method="GET" action="<?php echo base_url(); ?>index.php/ina_office_revenue"> 
                            <div class="row">
                                <div class="col-lg-3">
                            ...
                            <div class="pull-right">
                                <a href="<?php echo base_url().'index.php/report/ina_office_revenue_export/'.$tgl_awal.'/'.$tgl_akhir; ?>" class="btn btn-success" style="padding-right: 10px">
